  ...
  return (
    <section className="bg-gradient-to-b from-[#ffd3b6] via-rose-200 to-rose-300 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-pink-800 mb-12 tracking-tight">
...
//         {/* Grid - Fixed spacing and consistent card heights */}
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-6 lg:gap-8">
//           {blogs.map((blog) => (
//             <a key={blog._id} href={`/blog/${blog._id}`}
//               className="group flex flex-col bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-3 h-full">
...
//               {/* Text Section - Flexible height with consistent padding */}
//               <div className="p-5 sm:p-6 bg-[#ffd3b6] flex flex-col flex-grow">
//                 <h3 
//                   className="text-lg sm:text-xl font-bold text-gray-800 mb-3 line-clamp-2 leading-tight hover:text-pink-700 transition"
//                   dangerouslySetInnerHTML={{ __html: blog.title }}
//                 />
...
//                 <div className="flex items-center justify-between mt-auto pt-3 border-t border-pink-200">
//                   <span className="text-rose-600 font-semibold text-sm flex items-center gap-1 hover:text-rose-700 transition-colors">
//                     Read More
//                     <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
//                     </svg>
