...
//           <p className="text-lg sm:text-xl lg:text-2xl font-light text-pink-700 mb-2">Get in Touch With</p>
//           <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-700 via-rose-600 to-pink-800 leading-tight">
//             The Saltiam Team
//           </h1>
//           <p className="mt-5 text-base sm:text-lg lg:text-xl text-pink-700 font-medium max-w-3xl mx-auto">
//             We’re here to help you with any inquiry — big or small
//           </p>
//         </div>
...
//                   {[
//                     {
//                       // Office Icon SVG (commented down below)
//                       svg: (
//                         <svg className="w-full h-full text-rose-800 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
//                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
...
//                     },
//                   ].map((item, index) => (
//                    <div key={index} className="group flex flex-row items-start gap-5 p-6 rounded-2xl bg-gradient-to-r from-pink-50 to-rose-50 
//                     hover:from-pink-100 hover:to-rose-100 transition-all duration-300 border border-pink-200 hover:border-pink-400 hover:shadow-xl">
//                       {/* Icon - Left Side */}
//                       <div className="flex-shrink-0">
//                         <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white rounded-2xl shadow-lg p-3 
...
//                   {/* Quick Action Buttons - Responsive Grid */}
//                   <div className="mt-10 pt-8 border-t-2 border-pink-200 border-dashed">
//                     <h3 className="text-2xl font-bold text-pink-800 mb-6 text-center lg:text-left">
//                       Connect Instantly
//                     </h3>
//                     <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
//                       <a
...
//                         target="_blank"
//                         rel="noopener noreferrer"
//                         className="flex items-center justify-center gap-3 bg-gradient-to-r from-pink-600 to-rose-600 text-white py-4 px-3 rounded-xl font-bold hover:shadow-xl transform hover:scale-105 transition-all duration-300 text-sm sm:text-base"
//                       >
//                         Book Meeting
//                       </a>
//                       <a
...
//                         target="_blank"
//                         rel="noopener noreferrer"
//                         className="flex items-center justify-center gap-3 bg-green-500 text-white py-4 px-6 rounded-xl font-bold hover:bg-green-600 transform hover:scale-105 transition-all duration-300 text-sm sm:text-base"
//                       >
//                         WhatsApp
//                       </a>
//                     </div>
...
//                 {/* Right: Contact Form */}
//                 <div className="bg-gradient-to-br from-pink-50 via-rose-50 to-pink-100 rounded-3xl p-8 sm:p-10 lg:p-12 shadow-inner border border-pink-200">
//                   <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 text-center lg:text-left">
//                     Send Us a Message
//                   </h3>
//                   <p className="text-gray-600 mb-8 text-center lg:text-left text-sm sm:text-base">
//                     We typically reply within <strong className="text-pink-700">24 hours</strong>
//                   </p>
...
//                       placeholder="Your Full Name *"
//                       required
//                       className="w-full px-6 py-4 bg-white/90 border-2 border-rose-200 rounded-2xl focus:border-pink-500 focus:ring-4 focus:ring-pink-100 transition-all text-gray-800 placeholder-gray-500 text-base"
//                     />
//                     <input
//                       type="email"
//                       name="email"
...
//                       placeholder="How can we help you today? *"
//                       required
//                       className="w-full px-6 py-4 bg-white/90 border-2 border-rose-200 rounded-2xl focus:border-pink-500 focus:ring-4 focus:ring-pink-100 transition-all text-gray-800 placeholder-gray-500 text-base resize-none"
//                     ></textarea>

//                     <button
//                       type="submit"
//                       className="w-full bg-gradient-to-r from-pink-600 to-rose-700 text-white font-bold text-lg py-5 rounded-2xl shadow-2xl hover:shadow-pink-600/50 transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3"
//                     >
//                       Send Message
//                       <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M13 7l5 5m0 0l-5 5m5-5H6" />
